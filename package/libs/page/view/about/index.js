  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'about' },
        _react2.default.createElement(_alert2.default, { message: r2fn.t("这是一个关于页面！"), type: 'info', showIcon: true })
      );
    }
  }]);
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(View, 'View', 'src/page/view/about/index.jsx');

  __REACT_HOT_LOADER__.register(ReduxView, 'ReduxView', 'src/page/view/about/index.jsx');
}();
